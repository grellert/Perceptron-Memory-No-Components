...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone II" ENABLE_RUNTIME_MOD="NO" INIT_FILE="./text_files/rom_text_init.mif" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 q_a
...
module  rom_1_port_v2_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_0.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFDE08000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA40000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_2.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE0F0000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_3.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF260000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_4.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA40000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_5.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE00000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_6.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC80000000000000000000000000000000,
	...
	defparam
		...
		ram_block1a_7.mem_init0 = 256'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000000000000000000000000000,
...
endmodule //rom_1_port_v2_altsyncram
//VALID FILE
...
`endif
	...
	rom_1_port_v2_altsyncram	rom_1_port_v2_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
