...
add wave -noupdate /top_tb2/RAM_out
add wave -noupdate /top_tb2/inicio_mult
add wave -noupdate /top_tb2/pronto_mult
add wave -noupdate /top_tb2/mult_result_out
add wave -noupdate /top_tb2/pronto_div
add wave -noupdate /top_tb2/div_result_out
...
add wave -noupdate /top_tb2/y
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3451494 ps} 0}
...
update
WaveRestoreZoom {5079946 ps} {7069454 ps}
