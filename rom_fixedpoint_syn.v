...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone II" ENABLE_RUNTIME_MOD="NO" INIT_FILE="./text_files/rom_text_init.mif" NUMWORDS_A=1024 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=11 WIDTH_BYTEENA_A=1 WIDTHAD_A=10 address_a clock0 q_a
...
module  rom_fixedpoint_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block1a_8.init_file = "./text_files/rom_text_init.mif",
	...
	defparam
		...
		ram_block1a_9.init_file = "./text_files/rom_text_init.mif",
	...
	defparam
		...
		ram_block1a_10.init_file = "./text_files/rom_text_init.mif",
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: MGL_INTERNAL_WARNING: (Invalid line found in memory file.  Invalid line -- 00100000000:00000000101; -- found in file ./text_files/rom_text_init.mif)  ");
		$display("Warning: Memory initialization file ./text_files/rom_text_init.mif is not found. This may result in inconsistent simulation results.");
	end
endmodule //rom_fixedpoint_altsyncram
//VALID FILE
...
`endif
	...
	rom_fixedpoint_altsyncram	rom_fixedpoint_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
